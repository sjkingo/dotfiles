...
-- vicious widgets
-- https://github.com/Mic92/vicious#widget-types
-- https://awesomewm.org/apidoc/classes/wibox.html

-- Graph color
graph_color = { type = "linear",
                from = { 0, 0 },
                to = { 10, 0 },
                stops = {
                    { 0,   "#FF5656" },
...
-- CPU graph widget
w_cpugraph = wibox.widget {
    background_color = "#1E2320",
    color = graph_color,
    widget = wibox.widget.graph
}
vicious.register(w_cpugraph, vicious.widgets.cpu, "$1")

-- Memory graph widget
w_memgraph = wibox.widget {
    background_color = "#1E2320",
    color = graph_color,
    widget = wibox.widget.graph
}
vicious.register(w_memgraph, vicious.widgets.mem, "$1")

-- Network graph widget
w_netgraph = wibox.widget {
    background_color = "#1E2320",
    color = graph_color,
    widget = wibox.widget.graph
}
vicious.register(w_netgraph, vicious.widgets.net, "$1")

-- Date widget, every second
w_date = wibox.widget {
...
awful.rules.rules = {
    ...
    { rule_any = {
        ...
        role = {
          "pop-up",       -- Chrome detached windows
        }
